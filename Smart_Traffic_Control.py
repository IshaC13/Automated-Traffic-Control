...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Lane_One_AM = False
        self.Lane_Two_AM = False
        self.Lane_Three_AM = False
        self.Lane_Four_AM = False

        def ProcessLaneOneVideo():
            frame_count = 0
            VideoSourceLaneOne = cv2.VideoCapture(self.LaneOneVideoPath)
            print('Processing Thread One ',self.LaneOneVideoPath)
 
            Amb_counter = 0

            while True:
                _, frame = VideoSourceLaneOne.read()
                if _:
        ...
        def ProcessLaneTwoVideo():
            frame_count = 0
            VideoSourceLaneTwo = cv2.VideoCapture(self.LaneTwoVideoPath)
            print('Processing Thread Two ',self.LaneTwoVideoPath)
 
            while True:
                _, frame = VideoSourceLaneTwo.read()
                if _:
                    if frame_count != self.SkipFrameRate:
                        frame_count = frame_count + 1
                        pass
        ...
        def ProcessLaneThreeVideo():
            frame_count = 0
            VideoSourceLaneThree = cv2.VideoCapture(self.LaneThreeVideoPath)
            print('Processing Thread Three ',self.LaneThreeVideoPath)
 
            while True:
                _, frame = VideoSourceLaneThree.read()
                if _:
                    if frame_count != self.SkipFrameRate:
                        frame_count = frame_count + 1
                        pass
        ...
        def ProcessLaneFourVideo():
            frame_count = 0
            VideoSourceLaneFour = cv2.VideoCapture(self.LaneFourVideoPath)
            print('Processing Thread Four ',self.LaneFourVideoPath)
            while True:
                _, frame = VideoSourceLaneFour.read()
                if _:
                    if frame_count != self.SkipFrameRate:
                        frame_count = frame_count + 1
                        pass
        ...
        def btnCalculateResult(event):
            if (self.LaneOneVideoPath == None):
                messagebox.showerror('Lane 1 Missing', 'No Media Found at Lane 1')
                return
            if (self.LaneTwoVideoPath == None):
                messagebox.showerror('Lane 2 Missing', 'No Media Found at Lane 2')
                return

            if (self.LaneThreeVideoPath == None):
                messagebox.showerror('Lane 3 Missing', 'No Media Found at Lane 3')
                return

            if (self.LaneFourVideoPath == None):
                messagebox.showerror('Lane 4 Missing', 'No Media Found at Lane 4')
                return

            threading.Thread(target=ProcessLaneOneVideo).start()
            threading.Thread(target=ProcessLaneTwoVideo).start()
            threading.Thread(target=ProcessLaneThreeVideo).start()
            threading.Thread(target=ProcessLaneFourVideo).start()
        ...
        self.Label2.place(relx=0.21, rely=0.00, height=50, width=907)
        ...
        self.Label2.configure(text='''Automated Traffic Signal Controller''')
        self.Label2.configure(width=907)

        self.Label3 = tk.Label(top)
        self.Label3.place(relx=0.24, rely=0.08, height=20, width=807)
        ...
        self.Label3.configure(text='''P:Priority; VC: Vehhicle Count; EV: Emergency Vehicles; ET: Estimated Time''')
        self.Label3.configure(width=807)
        ...
        self.lblLaneTwoMedia.configure(text='''Select Lane 2 Media''')
        ...
        self.lblLaneFourMedia.configure(text='''Select Lane 4 Media''')
        ...
        self.lblLaneOneResult.configure(text='''Lane 1,  P: ,   VC :  ,   EV : ,    ET : Sec''')
        ...
        self.lblLaneTwoResult.configure(text='''Lane 2,  P:,   VC :  ,   EV : ,    ET :  Sec''')
        ...
        self.lblLaneThreeResult.configure(text='''Lane 3,  P:,   VC :  ,   EV : ,    ET :  Sec''')
        ...
        self.lblLaneFourResult.configure(text='''Lane 4,  P:,  VC :  ,   EV : ,    ET :  Sec''')
